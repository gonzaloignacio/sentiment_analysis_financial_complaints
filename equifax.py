...
Original file is located at
    https://colab.research.google.com/drive/1aNKzmxTIlu6Vp8NfeDobYGFgfr-PAu_k
"""
...
df = pd.read_excel('/content/drive/MyDrive/Colab Notebooks/Social Media Analytics/EQUIFAX INC..xlsx')
...
sns.histplot(data = df, x = "pos-neg score", color = "darkred")
plt.title("Distribution of scores for Equifax")
...
sns.countplot(data = df, x = "sentiment class", color = "darkred")
plt.title("Distribution of sentiment classes for Equifax")
...
plt.imshow(wordcloud, interpolation="bilinear")
plt.axis("off")
plt.title("Word Cloud of Most Common Words in Complaints with negative sentiment for Equifax")
plt.show()
...
plt.title("Most common words in complaints with undetected sentiment for Equifax")
...
sns.barplot(x = list(counts_neg), y = list(words_neg), color = "darkred")
plt.title("Most common words in complaints with negative sentiment for Equifax")
plt.xlabel("Frequency")
plt.ylabel("Word")
#plt.xticks(rotation = 45)
plt.show
